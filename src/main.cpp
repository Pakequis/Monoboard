...
void setup()
{
  ...
  // Has no dependency on WiFi/network state, so it runs ahead of the WiFi
  // phase below instead of waiting behind it -- avoids tying the sensor
  // reading's latency to however long that unrelated phase takes.
